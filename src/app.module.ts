...
import { ArticleCommentsLikes } from './modules/article/entities/article-comments-like.entity';
...
const envFilePath = `.env.${process.env.ENV || `development`}`;
export const IS_DEV = process.env.ENV !== 'production';
